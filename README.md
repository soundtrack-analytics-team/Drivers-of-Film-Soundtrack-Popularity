# Drivers of Film Soundtrack Popularity
Khurram Abbas, Tony Lett, Jaime Singson

For our Milestone 1 project for the University of Michigan's Applied Data Science (MADS) program, we studied the film-level and musical drivers of soundtrack streaming performance. The notebooks in this repository include the full scope of activites that we performed:
